...
class MockedMediaPipelineDeprecatedMethods(ImagesPipeline):
    ...
    def get_media_requests(self, item, info):
        ...
        return Request(
            item_url, meta={"response": Response(item_url, status=200, body=b"data")}
        )
    ...
    def media_to_download(self, request, info):
        self._mockcalled.append("media_to_download")
        return super(MockedMediaPipelineDeprecatedMethods, self).media_to_download(
            request, info
        )

    def media_downloaded(self, response, request, info):
        self._mockcalled.append("media_downloaded")
        return super(MockedMediaPipelineDeprecatedMethods, self).media_downloaded(
            response, request, info
        )

    def file_downloaded(self, response, request, info):
        self._mockcalled.append("file_downloaded")
        return super(MockedMediaPipelineDeprecatedMethods, self).file_downloaded(
            response, request, info
        )

    def file_path(self, request, response=None, info=None):
        self._mockcalled.append("file_path")
        return super(MockedMediaPipelineDeprecatedMethods, self).file_path(
    ...
    def image_downloaded(self, response, request, info):
        ...
        return super(MockedMediaPipelineDeprecatedMethods, self).image_downloaded(
            response, request, info
        )
...
class MediaPipelineDeprecatedMethodsTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.pipe = MockedMediaPipelineDeprecatedMethods(
            store_uri="store-uri", download_func=_mocked_download_func
        )
