...
class SpiderMiddlewareManager(MiddlewareManager):
    ...
    def _process_spider_exception(
        ...
        for method_index, method in enumerate(method_list, start=start_index):
            ...
            if _isiterable(result):
                ...
                return self._process_spider_output(
    ...
    def _process_spider_output(
        self, response: Response, spider: Spider, result: Iterable, start_index: int = 0
    ) -> MutableChain:
        ...
        for method_index, method in enumerate(method_list, start=start_index):
            ...
            if _isiterable(result):
                ...
                msg = (
                    f"Middleware {method.__qualname__} must return an "
    ...
    def _process_callback_output(
        self, response: Response, spider: Spider, result: Iterable
    ) -> MutableChain:
        recovered = MutableChain()
